...
export const LOGBOOK_WEAPONS: LogbookWeaponEntry[] = [
  ...
  { name: "Force Field", desc: "Persistent ring damage around the ship." },
  {
    ...
    desc: "Tracking explosives that pressure priority targets.",
  },
  ...
  {
    name: "Gravity Well",
    desc: "Pull field that bunches enemies before detonating.",
  },
];
...
export const LOGBOOK_MERGES: LogbookMergeEntry[] = [
  {
    result: "Beam Lash",
    desc: "Simultaneous bolt and arc pressure.",
    ingredients: [
      { name: "Laser", level: 3 },
      { name: "Plasma Whip", level: 2 },
    ],
  },
  {
    result: "Dark Matter",
    desc: "Massive piercing singularity burst.",
    ingredients: [
      { name: "Laser", level: 3 },
      { name: "Plasma Bomb", level: 2 },
    ],
  },
  {
    result: "Nova Burst",
    desc: "Wide aura plus outward bomb burst.",
    ingredients: [
      { name: "Force Field", level: 2 },
      { name: "Plasma Bomb", level: 3 },
    ],
  },
  {
    result: "Solar Flare",
    desc: "Piercing solar burst in all directions.",
    ingredients: [
      { name: "Laser", level: 2 },
      { name: "Pulse Cannon", level: 2 },
    ],
  },
  {
    result: "Quantum Torpedo",
    desc: "Oversized homing bomb for boss and elite kills.",
    ingredients: [
      { name: "Missile Barrage", level: 2 },
      { name: "Plasma Bomb", level: 2 },
    ],
  },
  {
    result: "Glacial Storm",
    desc: "Freeze field with repeating cryo pulses.",
    ingredients: [
      { name: "Cryo Beam", level: 2 },
      { name: "Force Field", level: 2 },
    ],
  },
  {
    result: "Arc Nova",
    desc: "Pulse burst backed by chain lightning arcs.",
    ingredients: [
      { name: "Ion Chain", level: 2 },
      { name: "Pulse Cannon", level: 2 },
    ],
  },
  {
    result: "Event Horizon",
    desc: "Pull field with repeated arc surges.",
    ingredients: [
      { name: "Ion Chain", level: 3 },
      { name: "Gravity Well", level: 2 },
    ],
  },
  {
    result: "Frost Barrage",
    desc: "Homing missiles that freeze on impact.",
    ingredients: [
      { name: "Missile Barrage", level: 2 },
      { name: "Cryo Beam", level: 2 },
    ],
  ...
  {
    result: "Cryo Lash",
    desc: "Freezing sweep arc for close-range control.",
    ingredients: [
      { name: "Plasma Whip", level: 2 },
      { name: "Cryo Beam", level: 2 },
    ],
  ...
  {
    result: "Aegis Array",
    desc: "Force pulse aura plus radial burst fire.",
    ingredients: [
      { name: "Force Field", level: 2 },
      { name: "Pulse Cannon", level: 2 },
    ],
  ...
  {
    result: "Cataclysm Core",
    desc: "Remote pull-core that ends in a heavy blast.",
    ingredients: [
      { name: "Gravity Well", level: 2 },
      { name: "Plasma Bomb", level: 2 },
    ],
  ...
  {
    result: "Static Bloom",
    desc: "Chain lightning hits that burst into splash blasts.",
    ingredients: [
      { name: "Ion Chain", level: 2 },
      { name: "Plasma Bomb", level: 2 },
    ],
  ...
  {
    result: "Graviton Veil",
    desc: "A pull aura that keeps enemies trapped in pulse range.",
    ingredients: [
      { name: "Force Field", level: 2 },
      { name: "Gravity Well", level: 2 },
    ],
  ...
  {
    result: "Volt Whorl",
    desc: "A whip sweep backed by radial burst fire.",
    ingredients: [
      { name: "Plasma Whip", level: 2 },
      { name: "Pulse Cannon", level: 2 },
    ],
...
export type LevelUpCallback = (
  choices: Upgrade[],
  apply: ApplyUpgradeFn,
) => void;
...
function pickWeightedUpgrades(available: Upgrade[], count: number): Upgrade[] {
  ...
  while (pool.length > 0 && picks.length < count) {
    const totalWeight = pool.reduce(
      (sum, upgrade) => sum + upgradeOfferWeight(upgrade),
      0,
    );
...
const UPGRADE_POOL: Upgrade[] = [
  ...
  {
    id: "bolt_damage",
    label: "🔵 Laser – Damage Up",
    desc: "+30% laser damage",
    icon: "Laser",
    apply: (w) => upgradeWeapon(w, "Laser", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Laser" && !x.isEvolution) &&
      weaponLevel(w, "Laser") < MAX_BASE_WEAPON_LEVEL,
  },
  {
    id: "bolt_rate",
    label: "🔵 Laser – Fire Rate Up",
    desc: "+25% fire rate",
    icon: "Laser",
  ...
  {
    id: "add_whip",
    label: "⚡ Unlock Plasma Whip",
    desc: "New weapon: sweeping plasma arc",
    icon: "Plasma Whip",
    ...
    requires: (w) =>
      ...
      !w.some((x) => x.name === "Volt Whorl") &&
      w.length < MAX_WEAPON_SLOTS,
  },
  {
    id: "whip_damage",
    label: "⚡ Plasma Whip – Damage Up",
    desc: "+30% whip damage",
    icon: "Plasma Whip",
    apply: (w) => upgradeWeapon(w, "Plasma Whip", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Plasma Whip" && !x.isEvolution) &&
      weaponLevel(w, "Plasma Whip") < MAX_BASE_WEAPON_LEVEL,
  },
  {
    id: "whip_range",
    label: "⚡ Plasma Whip – Range Up",
  ...
  {
    id: "add_fireball",
    label: "💠 Unlock Plasma Bomb",
    desc: "New weapon: slow explosive orb",
    icon: "Plasma Bomb",
    ...
    requires: (w) =>
      ...
      !w.some((x) => x.name === "Static Bloom") &&
      w.length < MAX_WEAPON_SLOTS,
  },
  {
    id: "fireball_damage",
    label: "💠 Plasma Bomb – Damage Up",
    desc: "+35% bomb damage",
    icon: "Plasma Bomb",
    apply: (w) => upgradeWeapon(w, "Plasma Bomb", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Plasma Bomb" && !x.isEvolution) &&
      weaponLevel(w, "Plasma Bomb") < MAX_BASE_WEAPON_LEVEL,
  },
  {
    id: "fireball_rate",
    label: "💠 Plasma Bomb – Fire Rate Up",
    desc: "+25% fire rate",
    icon: "Plasma Bomb",
  ...
  {
    id: "fireball_radius",
    label: "💠 Plasma Bomb – Blast Radius Up",
    desc: "+30px explosion radius",
    icon: "Plasma Bomb",
  ...
  {
    id: "add_lightning",
    label: "🔗 Unlock Ion Chain",
    desc: "New weapon: chain zap hitting multiple enemies",
    icon: "Ion Chain",
  ...
  {
    id: "lightning_damage",
    label: "🔗 Ion Chain – Damage Up",
    desc: "+30% chain damage",
    icon: "Ion Chain",
    apply: (w) => upgradeWeapon(w, "Ion Chain", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Ion Chain" && !x.isEvolution) &&
      weaponLevel(w, "Ion Chain") < MAX_BASE_WEAPON_LEVEL,
  },
  {
    id: "lightning_chains",
    label: "🔗 Ion Chain – Extra Link",
    desc: "Zap hits +1 more enemy",
    icon: "Ion Chain",
  ...
  {
    id: "add_aura",
    label: "🛡 Unlock Force Field",
    desc: "New weapon: pulsing damage ring",
    icon: "Force Field",
    ...
    requires: (w) =>
      ...
      !w.some((x) => x.name === "Graviton Veil") &&
      w.length < MAX_WEAPON_SLOTS,
  },
  {
    id: "aura_damage",
    label: "🛡 Force Field – Damage Up",
    desc: "+30% field damage",
    icon: "Force Field",
    apply: (w) => upgradeWeapon(w, "Force Field", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Force Field" && !x.isEvolution) &&
      weaponLevel(w, "Force Field") < MAX_BASE_WEAPON_LEVEL,
  },
  {
    id: "aura_range",
    label: "🛡 Force Field – Range Up",
    desc: "+25px field range",
    icon: "Force Field",
  ...
  {
    id: "aura_rate",
    label: "🛡 Force Field – Pulse Rate Up",
    desc: "+25% pulse rate",
    icon: "Force Field",
  ...
  {
    id: "player_hp",
    label: "🔋 Shield Capacity Up",
    desc: "+25 max shield and repair 25",
    icon: "shield_cap",
    apply: (_w, _add, player) => {
      player.maxHp += 25;
  ...
  // ── Evolutions ─────────────────────────────────────────────────────────────
  {
    ...
    icon: "Beam Lash",
    apply: (_w, add, _p, remove) => {
      remove("Laser");
      remove("Plasma Whip");
      add("Beam Lash");
    },
    requires: (w) =>
      weaponLevel(w, "Laser") >= 3 &&
      weaponLevel(w, "Plasma Whip") >= 2 &&
      !w.some((x) => x.name === "Beam Lash"),
  },
  {
    id: "evo_void_orb",
  ...
  },
  {
    ...
    requires: (w) =>
      weaponLevel(w, "Force Field") >= 2 &&
      weaponLevel(w, "Plasma Bomb") >= 3 &&
      !w.some((x) => x.name === "Nova Burst"),
  },
  {
    id: "evo_cryo_lash",
  ...
  {
    id: "add_missile",
    label: "🚀 Unlock Missile Barrage",
    desc: "New weapon: homing explosive missiles",
  ...
  {
    id: "missile_damage",
    label: "🚀 Missile Barrage – Damage Up",
    desc: "+30% missile damage",
    icon: "Missile Barrage",
    apply: (w) => upgradeWeapon(w, "Missile Barrage", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Missile Barrage" && !x.isEvolution) &&
      weaponLevel(w, "Missile Barrage") < MAX_BASE_WEAPON_LEVEL,
  },
  {
    id: "missile_rate",
    label: "🚀 Missile Barrage – Fire Rate Up",
    desc: "+22% fire rate",
    icon: "Missile Barrage",
  ...
  {
    id: "missile_count",
    label: "🚀 Missile Barrage – Salvo Up",
    desc: "+1 missile per volley",
    icon: "Missile Barrage",
  ...
  {
    id: "add_pulse",
    label: "💛 Unlock Pulse Cannon",
    desc: "New weapon: multi-directional burst",
    icon: "Pulse Cannon",
  ...
  {
    id: "pulse_damage",
    label: "💛 Pulse Cannon – Damage Up",
    desc: "+30% pulse damage",
    icon: "Pulse Cannon",
    apply: (w) => upgradeWeapon(w, "Pulse Cannon", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Pulse Cannon" && !x.isEvolution) &&
      weaponLevel(w, "Pulse Cannon") < MAX_BASE_WEAPON_LEVEL,
  },
  {
    id: "pulse_rate",
    label: "💛 Pulse Cannon – Fire Rate Up",
    desc: "+20% fire rate",
    icon: "Pulse Cannon",
  ...
  {
    id: "pulse_dirs",
    label: "💛 Pulse Cannon – More Directions",
    desc: "+2 fire directions",
    icon: "Pulse Cannon",
  ...
  {
    id: "add_cryo",
    label: "🧊 Unlock Cryo Beam",
    desc: "New weapon: freeze ray that slows enemies",
    icon: "Cryo Beam",
  ...
  {
    id: "cryo_damage",
    label: "🧊 Cryo Beam – Damage Up",
    desc: "+30% cryo damage",
    icon: "Cryo Beam",
    apply: (w) => upgradeWeapon(w, "Cryo Beam", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Cryo Beam" && !x.isEvolution) &&
      weaponLevel(w, "Cryo Beam") < MAX_BASE_WEAPON_LEVEL,
  },
  {
    id: "cryo_range",
    label: "🧊 Cryo Beam – Range Up",
    desc: "+40px beam range",
    icon: "Cryo Beam",
  ...
  },
  {
    ...
    requires: (w) =>
      weaponLevel(w, "Missile Barrage") >= 2 &&
      weaponLevel(w, "Plasma Bomb") >= 2 &&
      !w.some((x) => x.name === "Quantum Torpedo"),
  },
  {
  ...
  {
    id: "evo_static_bloom",
    label: "🔗💠 EVOLVE: Static Bloom",
    desc: "Merge Ion Chain lv2 + Plasma Bomb lv2 → chain blasts with splash damage",
    icon: "Static Bloom",
    apply: (_w, add, _p, remove) => {
      remove("Ion Chain");
      remove("Plasma Bomb");
  ...
  {
    id: "evo_graviton_veil",
    label: "🛡🌀 EVOLVE: Graviton Veil",
    desc: "Merge Force Field lv2 + Gravity Well lv2 → pull aura plus pulse field",
    icon: "Graviton Veil",
    apply: (_w, add, _p, remove) => {
      remove("Force Field");
      remove("Gravity Well");
  ...
  {
    id: "evo_volt_whorl",
    label: "⚡💛 EVOLVE: Volt Whorl",
    desc: "Merge Plasma Whip lv2 + Pulse Cannon lv2 → lash sweep plus radial burst",
    icon: "Volt Whorl",
    apply: (_w, add, _p, remove) => {
      remove("Plasma Whip");
      remove("Pulse Cannon");
  ...
  {
    id: "beam_lash_damage",
    label: "★ Beam Lash – Damage Up",
    desc: "+30% evolved bolt & arc damage",
    icon: "Beam Lash",
    apply: (w) => upgradeWeapon(w, "Beam Lash", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Beam Lash") &&
      weaponLevel(w, "Beam Lash") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "beam_lash_rate",
    label: "★ Beam Lash – Rate Up",
    desc: "+20% Beam Lash fire rate",
    icon: "Beam Lash",
  ...
  {
    id: "dark_matter_damage",
    label: "★ Dark Matter – Damage Up",
    desc: "+30% singularity damage",
    icon: "Dark Matter",
    apply: (w) => upgradeWeapon(w, "Dark Matter", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Dark Matter") &&
      weaponLevel(w, "Dark Matter") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "dark_matter_rate",
    label: "★ Dark Matter – Rate Up",
    desc: "+20% Dark Matter fire rate",
    icon: "Dark Matter",
  ...
  {
    id: "nova_burst_damage",
    label: "★ Nova Burst – Damage Up",
    desc: "+30% field & orb damage",
    icon: "Nova Burst",
    apply: (w) => upgradeWeapon(w, "Nova Burst", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Nova Burst") &&
      weaponLevel(w, "Nova Burst") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "nova_burst_range",
    label: "★ Nova Burst – Range Up",
    desc: "+25px field range",
    icon: "Nova Burst",
  ...
  },
  {
    ...
    label: "★ Solar Flare – Damage Up",
    desc: "+30% solar bolt damage",
    icon: "Solar Flare",
    apply: (w) => upgradeWeapon(w, "Solar Flare", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Solar Flare") &&
      weaponLevel(w, "Solar Flare") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "solar_flare_rate",
    label: "★ Solar Flare – Rate Up",
    desc: "+20% Solar Flare fire rate",
    icon: "Solar Flare",
  ...
  {
    id: "quantum_torpedo_damage",
    label: "★ Quantum Torpedo – Damage Up",
    desc: "+30% torpedo damage",
    icon: "Quantum Torpedo",
    apply: (w) => upgradeWeapon(w, "Quantum Torpedo", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Quantum Torpedo") &&
      weaponLevel(w, "Quantum Torpedo") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "quantum_torpedo_rate",
    label: "★ Quantum Torpedo – Rate Up",
    desc: "+20% torpedo fire rate",
    icon: "Quantum Torpedo",
  ...
  {
    id: "glacial_storm_damage",
    label: "★ Glacial Storm – Damage Up",
    desc: "+30% storm damage",
    icon: "Glacial Storm",
    apply: (w) => upgradeWeapon(w, "Glacial Storm", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Glacial Storm") &&
      weaponLevel(w, "Glacial Storm") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "glacial_storm_range",
    label: "★ Glacial Storm – Range Up",
    desc: "+30px storm range",
    icon: "Glacial Storm",
  ...
  {
    id: "arc_nova_damage",
    label: "★ Arc Nova – Damage Up",
    desc: "+30% burst and chain damage",
    icon: "Arc Nova",
    apply: (w) => upgradeWeapon(w, "Arc Nova", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Arc Nova") &&
      weaponLevel(w, "Arc Nova") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "arc_nova_rate",
    label: "★ Arc Nova – Rate Up",
    desc: "+18% Arc Nova fire rate",
    icon: "Arc Nova",
  ...
  {
    id: "event_horizon_damage",
    label: "★ Event Horizon – Damage Up",
    desc: "+30% pulse and arc damage",
    icon: "Event Horizon",
    apply: (w) => upgradeWeapon(w, "Event Horizon", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Event Horizon") &&
      weaponLevel(w, "Event Horizon") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "event_horizon_range",
    label: "★ Event Horizon – Range Up",
    desc: "+30px pull field range",
    icon: "Event Horizon",
  ...
  {
    id: "frost_barrage_damage",
    label: "★ Frost Barrage – Damage Up",
    desc: "+30% frost missile damage",
    icon: "Frost Barrage",
    apply: (w) => upgradeWeapon(w, "Frost Barrage", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Frost Barrage") &&
      weaponLevel(w, "Frost Barrage") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "frost_barrage_rate",
    label: "★ Frost Barrage – Rate Up",
    desc: "+18% frost missile fire rate",
    icon: "Frost Barrage",
  ...
  {
    id: "cryo_lash_damage",
    label: "★ Cryo Lash – Damage Up",
    desc: "+30% lash damage",
    icon: "Cryo Lash",
    apply: (w) => upgradeWeapon(w, "Cryo Lash", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Cryo Lash") &&
      weaponLevel(w, "Cryo Lash") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "cryo_lash_range",
    label: "★ Cryo Lash – Range Up",
    desc: "+30px lash range",
    icon: "Cryo Lash",
  ...
  {
    id: "aegis_array_damage",
    label: "★ Aegis Array – Damage Up",
    desc: "+30% pulse and burst damage",
    icon: "Aegis Array",
    apply: (w) => upgradeWeapon(w, "Aegis Array", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Aegis Array") &&
      weaponLevel(w, "Aegis Array") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "aegis_array_range",
    label: "★ Aegis Array – Range Up",
    desc: "+25px pulse field range",
    icon: "Aegis Array",
  ...
  {
    id: "cataclysm_core_damage",
    label: "★ Cataclysm Core – Damage Up",
    desc: "+30% core detonation damage",
    icon: "Cataclysm Core",
    apply: (w) => upgradeWeapon(w, "Cataclysm Core", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Cataclysm Core") &&
      weaponLevel(w, "Cataclysm Core") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "cataclysm_core_range",
    label: "★ Cataclysm Core – Range Up",
    desc: "+30px pull radius",
    icon: "Cataclysm Core",
  ...
  {
    id: "static_bloom_damage",
    label: "★ Static Bloom – Damage Up",
    desc: "+30% chain and splash damage",
    icon: "Static Bloom",
    apply: (w) => upgradeWeapon(w, "Static Bloom", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Static Bloom") &&
      weaponLevel(w, "Static Bloom") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "static_bloom_range",
    label: "★ Static Bloom – Chain Range Up",
    desc: "+30px chain reach",
    icon: "Static Bloom",
    apply: (w) => upgradeWeapon(w, "Static Bloom", "range"),
    requires: (w) =>
      w.some((x) => x.name === "Static Bloom") &&
      weaponLevel(w, "Static Bloom") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "graviton_veil_damage",
    label: "★ Graviton Veil – Damage Up",
    desc: "+30% veil pulse damage",
    icon: "Graviton Veil",
    apply: (w) => upgradeWeapon(w, "Graviton Veil", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Graviton Veil") &&
      weaponLevel(w, "Graviton Veil") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "graviton_veil_range",
    label: "★ Graviton Veil – Range Up",
    desc: "+25px veil radius",
    icon: "Graviton Veil",
    apply: (w) => upgradeWeapon(w, "Graviton Veil", "range"),
    requires: (w) =>
      w.some((x) => x.name === "Graviton Veil") &&
      weaponLevel(w, "Graviton Veil") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "volt_whorl_damage",
    label: "★ Volt Whorl – Damage Up",
    desc: "+30% lash and burst damage",
    icon: "Volt Whorl",
    apply: (w) => upgradeWeapon(w, "Volt Whorl", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Volt Whorl") &&
      weaponLevel(w, "Volt Whorl") < MAX_EVO_WEAPON_LEVEL,
  },
  {
    id: "volt_whorl_range",
    label: "★ Volt Whorl – Range Up",
    desc: "+30px lash range",
    icon: "Volt Whorl",
    apply: (w) => upgradeWeapon(w, "Volt Whorl", "range"),
    requires: (w) =>
      w.some((x) => x.name === "Volt Whorl") &&
      weaponLevel(w, "Volt Whorl") < MAX_EVO_WEAPON_LEVEL,
  },
  ...
  {
    id: "gen_atk_speed",
    label: "⚡ Systems Overclock",
    desc: "All weapons fire 15% faster",
    icon: "atk_speed",
    apply: (w, _add, player) => {
  ...
  {
    id: "gen_damage",
    label: "💥 Weapons Amplifier",
    desc: "All weapons deal 20% more damage",
    icon: "damage_amp",
    apply: (w, _add, player) => {
      player.damageMult *= 1.2;
      player.damageUpgrades++;
      for (const weapon of w) weapon.scaleStats(1.0, 1.2);
    },
  ...
  },
  {
    id: "gen_pickup",
    label: "🧲 Tractor Beam",
    desc: "+30 gem attraction radius",
    icon: "tractor_beam",
    apply: (_w, _add, player) => {
      player.pickupRadius += 30;
      player.pickupUpgrades++;
    },
  ...
  {
    id: "add_gravity_well",
    label: "🌀 Unlock Gravity Well",
    desc: "New weapon: pulls & detonates",
    icon: "Gravity Well",
  ...
  {
    id: "gravity_well_damage",
    label: "🌀 Gravity Well – Damage Up",
    desc: "+35% detonation damage",
    icon: "Gravity Well",
    apply: (w) => upgradeWeapon(w, "Gravity Well", "damage"),
    requires: (w) =>
      w.some((x) => x.name === "Gravity Well" && !x.isEvolution) &&
      weaponLevel(w, "Gravity Well") < MAX_BASE_WEAPON_LEVEL,
  },
  {
    id: "gravity_well_radius",
    label: "🌀 Gravity Well – Pull Radius",
    desc: "+40px pull radius",
    icon: "Gravity Well",
  ...
  {
    id: "gravity_well_rate",
    label: "🌀 Gravity Well – Cooldown Down",
    desc: "−20% cooldown",
    icon: "Gravity Well",
